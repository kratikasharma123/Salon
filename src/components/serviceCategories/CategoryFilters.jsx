...
import { categoryStatuses } from '../../utils/categoryMapper'
...
function CategoryFilters({ filters, onChange, onClear }) {
  return (
    <section className="rounded-[2rem] border border-beige bg-white p-5 shadow-soft" aria-label="Service category filters">
